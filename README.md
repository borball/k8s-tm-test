...
In combination with ‘--topology-manager-scope=pod’ and ‘--topology-manager-policy=pod’, a pod should be rejected when a single NUMA node cannot meet the Pod resource requirement (i.g. A Pod needs more than 1 NUMA node).
